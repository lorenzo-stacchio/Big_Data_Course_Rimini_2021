...
if __name__ == '__main__':
    ...
    final_df["name"] = [names.get_first_name() for i in range(len(final_df))]
    final_df["surname"] = [names.get_last_name() for i in range(len(final_df))]
    final_df.to_csv("boomer_non_boomer_names.csv", index=False)
